...
public class FlashMemory extends DigitalProduct {
    ...
    public FlashMemory(String id, String name, double price, int stock, String brand, int usbVersion) {
        super(id, name, price, stock, brand);
        this.usbVersion = usbVersion;
    }

    public int getUsbVersion() { return usbVersion; }
    public void setUsbVersion(int usbVersion) { this.usbVersion = usbVersion; }
}